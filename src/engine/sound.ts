/**
 * sound.ts — procedural sound effects via the Web Audio API (copied from
 * patterns/). Zero asset files, offline-capable. Call sfx.unlock() from the
 * first user gesture, then sfx.play('coin').
 */
...
const PATCHES: Record<SfxName, Patch> = {
  ...
  jump: { type: 'sine', freq: [220, 640], dur: 0.18, gain: 0.26 },
  hit: { type: 'sawtooth', freq: [300, 90], dur: 0.14, gain: 0.24, noise: true },
